  ...
  if (fs.existsSync("./config.json")) {
    ...
    if (missingValues.length > 0) {
      ...
      if (answers.statusEnabled !== undefined) {
        ...
        if (!answers.statusEnabled) {
          config.status = { text: null, type: null };
        }
      }
      ...
      if (answers.supportEnabled !== undefined) {
        ...
        if (!answers.supportEnabled) {
          config.supportStatus = null;
          config.supportRole = null;
        }
      }
    ...
    config = {
      ...
      autoRole: answers.autoRoleEnabled ? (answers.autoRole ? answers.autoRole.trim() : null) : null,
      welcomeEnabled: answers.welcomeEnabled,
      welcomeChannel: answers.welcomeEnabled ? (answers.welcomeChannel ? answers.welcomeChannel.trim() : null) : null,
      supportEnabled: answers.supportEnabled,
      supportStatus: answers.supportEnabled ? (answers.supportStatus ? answers.supportStatus.trim() : null) : null,
      supportRole: answers.supportEnabled ? (answers.supportRole ? answers.supportRole.trim() : null) : null,
    };
